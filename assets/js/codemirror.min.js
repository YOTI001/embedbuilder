!(function (e, t) {
			...
			function (e, t) {
				...
				for (var L = 0; L < i; ++L)
					if (ce.test(o[L])) {
						...
						for (
							var T = 'L' == (L ? o[L - 1] : n), M = T == ('L' == (k < i ? o[k] : n)) ? (T ? 'L' : 'R') : n, N = L;
							N < k;
							++N
						)
							o[N] = M;
				...
				for (var A, O = [], D = 0; D < i; )
					if (de.test(o[D])) {
						...
						for (var P = H; P < D; )
							if (fe.test(o[P])) {
								H < P && (O.splice(F, 0, new ge(1, H, P)), (F += E));
								var I = P;
								for (++P; P < D && fe.test(o[P]); ++P);
								O.splice(F, 0, new ge(2, I, P)), (F += E), (H = P);
							} else ++P;
				...
				return (
					'ltr' == t &&
						...
						1 == Y(O).level &&
							(A = e.match(/\s+$/)) &&
							((Y(O).to -= A[0].length), O.push(new ge(0, i - A[0].length, i)))),
					'rtl' == t ? O.reverse() : O
				);
			});
	function ge(e, t, n) {
	...
	function we(e, t, n) {
		...
		e.removeEventListener
			...
			: !(e = (r = e._handlers) && r[t]) || (-1 < (n = R(e, n)) && (r[t] = e.slice(0, n).concat(e.slice(n + 1))));
	}
	function xe(e, t) {
		var n = be(e, t);
	...
	var Ve = {};
	function Ke(e, t) {
		E(t, Ve.hasOwnProperty(e) ? Ve[e] : (Ve[e] = {}));
	}
	function je(e, t) {
		if (!0 === t) return t;
	...
	function mt(n, r, e) {
		...
		var o = (function (e, t, n) {
				for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; l < s; --s) {
					...
					a = P(a.text, null, e.options.tabSize);
	...
	function xt(e, t, n, r) {
		...
		for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
			(c.start = c.pos), (i = bt(s, c, u.state)), r && o.push(new wt(c, i, je(l.mode, u.state)));
		...
		if (o)
			for (var l = 0; l < o.length; ++l) {
				...
				if (s.marker.collapsed) {
					...
					if (
						!((0 <= u && c <= 0) || (u <= 0 && 0 <= c)) &&
						((u <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= it(a.to, n) : 0 < it(a.to, n))) ||
							(0 <= u && (s.marker.inclusiveRight && i.inclusiveLeft ? it(a.from, r) <= 0 : it(a.from, r) < 0)))
					)
						return 1;
				}
			}
							...
							if (v) {
								...
								if (
									(d ||
										...
										t.addToken(t, N, s ? s + u : u, h, g + N.length == y ? c : '', a, f)),
									M <= A)
								) {
									(v = v.slice(M - g)), (g = M);
									break;
						...
						r.content.appendChild(
							(function (e) {
								null == We &&
									...
									0 != e.firstChild.offsetHeight && (We = t.offsetWidth <= 1 && 2 < t.offsetHeight && !(w && v < 8)));
								var t = We
									? M('span', '​')
				...
				for (var h = 0; ; ) {
					...
					'\t' == d[0]
						? ((f = (f = e.cm.options.tabSize) - (e.col % f)),
						  (p = s.appendChild(M('span', X(f), 'cm-tab'))).setAttribute('role', 'presentation'),
						  p.setAttribute('cm-text', '\t'),
						  (e.col += f))
						: ('\r' == d[0] || '\n' == d[0]
								? (p = s.appendChild(M('span', '\r' == d[0] ? '␍' : '␤', 'cm-invalidchar'))).setAttribute(
										'cm-text',
										d[0]
								  )
	...
	function Jt(e, t, n, r) {
		...
		i && e.map.push(e.pos, e.pos + t, i),
			!r &&
				...
				(i = i || e.content.appendChild(document.createElement('span'))).setAttribute('cm-marker', n.id),
	...
	function hn(e, t) {
		var n, r;
		(n = e),
			(r = (i = t).bgClass ? i.bgClass + ' ' + (i.line.bgClass || '') : i.line.bgClass) &&
	...
	function Sn(e, t, n) {
		...
		for (var i = 0; i < e.rest.length; i++)
			if (Je(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
	}
	function Ln(e, t, n, r) {
				...
				: (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
				  ...
				  (o = (function (e, t, n, r) {
						...
						!(w && v < 9) ||
							...
							(i = m ? { left: m.left, right: m.left + _n(e.display), top: m.top, bottom: m.bottom } : An));
						for (
							var h = i.top - t.rect.top, n = i.bottom - t.rect.top, d = (h + n) / 2, f = t.view.measure.heights, p = 0;
							p < f.length - 1 && !(d < f[p]);
							p++
						);
						var g = p ? f[p - 1] : 0,
	...
	function In(e, t, n, r, i) {
		if ((i || ((i = Pn(t)), (n.top += i), (n.bottom += i)), 'line' == r)) return n;
		r = r || 'local';
		t = Vt(t);
		return (
			'local' == r ? (t += vn(e.display)) : (t -= e.display.viewOffset),
			('page' != r && 'window' != r) ||
				((t += (e = e.display.lineSpace.getBoundingClientRect()).top + ('window' == r ? 0 : En())),
	...
	function Rn(e, t, n) {
		...
		'page' == n
			? ((r -= Fn()), (t -= En()))
			: ('local' != n && n) || ((r += (n = e.display.sizer.getBoundingClientRect()).left), (t += n.top));
			...
			var s = (function (n, e, t, r, i) {
							...
							n.options.lineWrapping
								? function (e, t, n, r, i, o, l) {
										...
										for (var u = null, c = null, h = 0; h < i.length; h++) {
											...
											f.from >= a ||
												f.to <= s ||
												((d = 1 != f.level),
												(d = Mn(e, r, d ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right),
												(d = d < o ? o - d + 1e9 : d - o),
												(!u || d < c) && ((u = f), (c = d)));
										}
										u = u || i[i.length - 1];
								...
								: function (n, r, i, o, l, s, a) {
											...
											t = l[e];
										{
											...
											0 < e &&
												((u = 1 != t.level),
												Xn((u = Bn(n, rt(i, u ? t.from : t.to, u ? 'after' : 'before'), 'line', r, o)), s, a, !0) &&
													u.top > a &&
													(t = l[e - 1]));
										}
										return t;
					...
					var h = null,
						...
						c = ie(
							function (e) {
								var t = Mn(n, o, e);
								return (
									(t.top += l), (t.bottom += l), Xn(t, r, i, !1) && (t.top <= i && t.left <= r && ((h = e), (d = t)), 1)
								);
							},
							s,
							a
						...
						f = !1;
					{
						...
						d
							...
							: (u || (c != a && c != s) || c++,
							  (g =
									0 == c || (c != e.text.length && Mn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u)
										? 'after'
										: 'before'),
	...
	function Jn(e, t, n, r) {
		...
		return (
			r &&
				...
				((a = P(a, a.length, e.options.tabSize) - a.length),
				(i = rt(i.line, Math.max(0, Math.round((o - bn(e.display).left) / _n(e.display)) - a)))),
			i
		);
	}
	function er(e, t) {
		...
		r && n < l.viewTo && (null == l.updateLineNumbers || l.updateLineNumbers > t) && (l.updateLineNumbers = t),
			...
			t >= l.viewTo
				...
				: ((i = ir(e, t, t, -1)),
				  (o = ir(e, n, n + r, 1)),
				  i && o
						? ((l.view = l.view.slice(0, i.index).concat(tn(e, i.lineN, o.lineN)).concat(l.view.slice(o.index))),
						  (l.viewTo += r))
						: rr(e));
					...
					(function (i, e, t) {
								...
								(function (e, t, n, r) {
									...
									for (var i = !1, o = 0; o < e.length; ++o) {
										...
										((l.from < n && l.to > t) || (t == n && l.to == t)) &&
											(r(Math.max(l.from, t), Math.min(l.to, n), 1 == l.level ? 'rtl' : 'ltr', o), (i = !0));
									}
									i || r(t, n, 'ltr');
						...
						a.line == n.line
							...
							: ((r = $e(o, a.line)),
							  ...
							  e &&
									(r.top < n.top - 2
										? (T(r.right, r.top, null, r.bottom), T(S, n.top, n.left, n.bottom))
		...
		return (
			n &&
				...
				i < o
					...
					: Math.min(n, t.lastLine()) >= r && ((o = et(t, Vt($e(t, n)) - e.wrapper.clientHeight)), (r = n))),
	...
	function yr(e, t) {
		...
		t.top < i
			...
			: t.bottom > i + o && (u = Math.min(t.top, (r ? s : t.bottom) - o)) != i && (l.scrollTop = u);
	...
	function Dr(n) {
		n.display.scrollbars &&
			...
			n.display.scrollbars.addClass && L(n.display.wrapper, n.display.scrollbars.addClass)),
					...
					for (var t = e.ops, n = 0; n < t.length; n++)
						!(function (e) {
							...
							(e.mustUpdate =
								...
								(e.update =
									e.mustUpdate &&
									new Gr(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
						})(t[n]);
							...
							(e.barMeasure = Mr(t)),
								n.maxLineChanged &&
									...
									(e.barMeasure.scrollWidth = Math.max(
										...
										n.sizer.offsetLeft + e.adjustWidthTo + wn(t) + t.display.barWidth
									)),
									...
									((i = (function (e, t, n, r) {
										null == r && (r = 0),
											e.options.lineWrapping ||
												...
												(n =
													'before' ==
													(t = t.ch ? rt(t.line, 'before' == t.sticky ? t.ch - 1 : t.ch, 'after') : t).sticky
										...
										for (var i = 0; i < 5; i++) {
											var o,
												...
												a = e.doc.scrollLeft;
											if (
												(null != u.scrollTop && (Lr(e, u.scrollTop), 1 < Math.abs(e.doc.scrollTop - s) && (l = !0)),
		...
		return (
			...
			(function (n, e, t) {
				...
				function s(e) {
					var t = e.nextSibling;
					return (
						f && g && n.display.currentWheelTarget == e ? (e.style.display = 'none') : e.parentNode.removeChild(e), t
					);
				}
				for (var a = r.view, u = r.viewFrom, c = 0; c < a.length; c++) {
					...
					if (!h.hidden)
						if (h.node && h.node.parentNode == o) {
							...
							h.changes && (-1 < R(h.changes, 'gutter') && (d = !1), an(n, h, u, t)),
								d && (k(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(nt(n.options, u)))),
			...
			s && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), zr(e, 400)),
	...
	function Vr(e, t) {
		for (var n = t.viewport, r = !0; ; r = !1) {
			if (r && e.options.lineWrapping && t.oldDisplayWidth != xn(e)) r && (t.visible = vr(e.display, e.doc, n));
				...
				(n && null != n.top && (n = { top: Math.min(e.doc.height + yn(e.display) - Cn(e), n.top) }),
	...
	function Yr(e) {
		...
		if (t.alignWidgets || (t.gutters.firstChild && e.options.fixedGutter)) {
			for (
				var r = qn(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + 'px', l = 0;
				l < n.length;
				l++
			)
				if (!n[l].hidden) {
						...
						? ((o.wheelStartX = l.scrollLeft),
						  ...
						  setTimeout(function () {
								...
								null != o.wheelStartX &&
									...
									(t =
										((e = l.scrollTop - o.wheelStartY) && o.wheelDY && e / o.wheelDY) ||
	...
	function Ci(e, t, n, r) {
		...
		if (
			...
			var a = Y(i.done);
			for (
				(a && a.ranges) || Li(e.sel, i.done), o = { changes: [wi(e, t)], generation: i.generation }, i.done.push(o);
	...
	function Ai(e, t, n, r) {
		if (r) {
			r = e.anchor;
			return (
				n && ((e = it(t, r) < 0) != it(n, r) < 0 ? ((r = t), (t = n)) : e != it(t, n) < 0 && (t = n)), new oi(r, t)
			);
		}
		return new oi(n || t, t);
	}
	function Oi(e, t, n, r, i) {
		null == i && (i = e.cm && (e.cm.display.shift || e.extend)), Ei(e, new ii([Ai(e.sel.primary(), t, n, i)], 0), r);
	}
	function Di(e, t, n) {
		for (var r = [], i = e.cm && (e.cm.display.shift || e.extend), o = 0; o < e.sel.ranges.length; o++)
			r[o] = Ai(e.sel.ranges[o], t[o], null, i);
		Ei(e, li(e.cm, r, e.sel.primIndex), n);
	}
	function Wi(e, t, n, r) {
		var i = e.sel.ranges.slice(0);
		(i[t] = n), Ei(e, li(e.cm, i, e.sel.primIndex), r);
	}
	function Hi(e, t, n, r) {
		Ei(e, si(t, n), r);
	}
	function Fi(e, t, n) {
		var r = e.history.done,
			i = Y(r);
		i && i.ranges ? Pi(e, (r[r.length - 1] = t), n) : Ei(e, t, n);
	}
	function Ei(e, t, n) {
		Pi(e, t, n), Si(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n);
	}
	function Pi(e, t, n) {
		var r, i;
	...
	function Ii(e, t) {
		t.equals(e.sel) ||
			((e.sel = t),
			e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Se(e.cm)),
					...
					if (a.atomic) {
						if (n) {
							var h = a.find(r < 0 ? 1 : -1),
								s = void 0;
							if (
								((r < 0 ? c : u) && (h = Ui(e, h, -r, h && h.line == t.line ? o : null)),
								h && h.line == t.line && (s = it(h, n)) && (r < 0 ? s < 0 : 0 < s))
							)
								return Bi(e, h, t, r, i);
						}
						a = a.find(r < 0 ? -1 : 1);
	...
	function ji(e, t, n) {
		if (e.cm) {
			if (!e.cm.curOp) return Pr(e.cm, ji)(e, t, n);
		...
		if (!(Le(e, 'beforeChange') || (e.cm && Le(e.cm, 'beforeChange'))) || (t = Ki(e, t, !0))) {
			...
			if (r)
				for (var i = r.length - 1; 0 <= i; --i)
					Xi(e, { from: r[i].from, to: r[i].to, text: i ? [''] : t.text, origin: t.origin });
			else Xi(e, t);
		}
	}
	function Xi(e, n) {
		...
		(1 == n.text.length && '' == n.text[0] && 0 == it(n.from, n.to)) ||
			...
			(r = []),
			mi(e, function (e, t) {
				t || -1 != R(r, e.history) || (Ji(e.history, n), r.push(e.history)), $i(e, n, null, Nt(e, n));
			}));
	}
	function Yi(i, o, e) {
		...
		if (!t || e) {
			...
			if (u != s.length) {
				for (n.lastOrigin = n.lastSelOrigin = null; ; ) {
					...
					if ((Li(l, a), e && !l.equals(i.sel))) return void Ei(i, l, { clearRedo: !1 });
					r = l;
				}
				var c = [];
				Li(r, a), a.push({ changes: c, generation: n.generation }), (n.generation = l.generation || ++n.maxGeneration);
				for (
					var h = Le(i, 'beforeChange') || (i.cm && Le(i.cm, 'beforeChange')), d = l.changes.length - 1;
					0 <= d;
					--d
				) {
					var f = (function (e) {
						...
						var r = [];
						mi(i, function (e, t) {
							t || -1 != R(r, e.history) || (Ji(e.history, n), r.push(e.history)), $i(e, n, null, Mi(e, n));
						});
					})(d);
					if (f) return f.v;
				}
	...
	function $i(e, t, n, r) {
		if (e.cm && !e.cm.curOp) return Pr(e.cm, $i)(e, t, n, r);
		var i;
		t.to.line < e.first
			...
			: t.from.line > e.lastLine() ||
			  (t.from.line < e.first &&
					...
					(t = { from: rt(e.first, 0), to: rt(t.to.line + i, t.to.ch), text: [Y(t.text)], origin: t.origin })),
			  (i = e.lastLine()),
			  ...
			  e.cm
					? (function (e, t, n) {
							...
							(a || r) &&
								((t = { from: o, to: l, text: t.text, removed: t.removed, origin: t.origin }),
								a && ln(e, 'change', e, t),
		...
		(to.prototype = {
			...
			removeInner: function (e, t) {
				for (var n, r = e, i = e + t; r < i; ++r) {
					var o = this.lines[r];
					(this.height -= o.height), ((n = o).parent = null), Ot(n), ln(o, 'delete');
				}
		...
		(no.prototype = {
			...
			removeInner: function (e, t) {
				...
				this.size - t < 25 &&
					...
					((n = []), this.collapse(n), (this.children = [new to(n)]), (this.children[0].parent = this));
			},
			collapse: function (e) {
				...
				if (!(this.children.length <= 10)) {
					...
					do {
						...
						(e.parent
							...
							: ((((t = new no(e.children)).parent = e).children = [t, n]), (e = t)),
						(n.parent = e.parent),
	...
	function so(t, n, r, e, i) {
		...
		if (t.cm && !t.cm.curOp) return Pr(t.cm, so)(t, n, r, e, i);
		var o = new lo(t, i),
			i = it(n, r);
		if ((e && E(e, o, !1), 0 < i || (0 == i && !1 !== o.clearWhenEmpty))) return o;
		if (
			(o.replacedWith &&
				((o.collapsed = !0),
	...
	(lo.prototype.clear = function () {
			...
			r &&
				...
				Er(o, function () {
					...
					t && (Dn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
						...
						Ut(i.doc, e) ||
							null == i.height ||
							((t = i.height), (i.height = null), (t = gn(i) - t) && Qe(e, e.height + t)),
		...
		(lo.prototype.attachLine = function (e) {
			...
			!this.lines.length &&
				this.doc.cm &&
				(((t = this.doc.cm.curOp).maybeHiddenMarkers && -1 != R(t.maybeHiddenMarkers, this)) ||
	...
	(ho.prototype = q(no.prototype, {
		...
		setValue: Rr(function (e) {
			...
			ji(
				this,
				{ from: t, to: rt(n, $e(this, n).text.length), text: this.splitLines(e), origin: 'setValue', full: !0 },
				!0
			),
		...
		setSelections: Rr(function (e, t, n) {
			if (e.length) {
				...
				null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), Ei(this, li(this.cm, r, t), n);
			}
		}),
		addSelection: Rr(function (e, t, n) {
			var r = this.sel.ranges.slice(0);
			r.push(new oi(ct(this, e), ct(this, t || e))), Ei(this, li(this.cm, r, r.length - 1), n);
		}),
						...
						(function (e, t, n) {
							for (var r = [], i = (u = rt(e.first, 0)), o = 0; o < t.length; o++) {
								var l = t[o],
									...
									i = a;
								'around' == n
									? ((l = it((l = e.sel.ranges[o]).head, l.anchor) < 0), (r[o] = new oi(l ? a : s, l ? s : a)))
									: (r[o] = new oi(s, s));
							}
			...
			return (
				...
				eo(r, e, 'widget', function (e) {
					...
					return (
						...
						o &&
							!Ut(r, e) &&
							((t = Vt(e) < r.scrollTop), Qe(e, e.height + gn(i)), t && br(o, i.height), (o.curOp.forceUpdate = !0)),
						1
					);
				}),
			...
			if (t && !r.isReadOnly())
				if (n && n.length && window.FileReader && window.File)
					for (
						...
						!(function (e, t) {
							var n;
							r.options.allowDropFileTypes && -1 == R(r.options.allowDropFileTypes, e.type)
								? s()
					...
					try {
						...
						if (c) {
							if (
								(r.state.draggingText && !r.state.draggingText.copy && (u = r.listSelections()), Pi(r.doc, si(t, t)), u)
							)
	...
	function Oo(e, t) {
		...
		var n = wo[e.keyCode];
		return null != n && !e.altGraphKey && (3 == e.keyCode && e.code && (n = e.code), Ao(n, e, t));
	}
	function Do(e) {
						...
						(t = $e(l.doc, e.line).text) &&
							...
							0 < e.ch
								? ((e = new rt(e.line, e.ch + 1)),
								  l.replaceRange(t.charAt(e.ch - 1) + t.charAt(e.ch - 2), rt(e.line, e.ch - 2), e, '+transpose'))
								: e.line > l.doc.first &&
	...
	function Ro(e, t) {
		var n = $e(e.doc, t),
			r = zt(n);
		return r != n && (t = Je(r)), Eo(!0, e, r, t, 1);
	}
	function zo(e, t) {
		var n = Ro(e, t.line),
			r = $e(e.doc, n.line),
	...
	function Xo(e) {
		...
		function o(e) {
			(18 != e.keyCode && e.altKey) ||
				(L(r, 'CodeMirror-crosshair'), we(document, 'keyup', o), we(document, 'mouseover', o));
		}
		(e.target && e.target != i.display.input.getField()) ||
			...
			Ce(i, e) ||
				...
				p &&
					((jo = n ? t : null),
					!n && 88 == t && !Ie && (g ? e.metaKey : e.ctrlKey) && i.replaceSelection('', null, 'cut')),
				...
				: tl(l, e) ||
				  ...
				  (t &&
						(function (n, e, r, t, i) {
							...
							return Uo(n, Ao((o = (1 == e ? 'Left' : 2 == e ? 'Middle' : 'Right') + o), i), i, function (e) {
										...
										(e.options.dragDrop &&
													...
													var o = t.display,
														...
														s = Pr(t, function (e) {
															f && (o.scroller.draggable = !1),
																...
																l ||
																	(Te(e),
																	i.addNew || Oi(t.doc, r, null, null, i.extend),
																	(f && !c) || (w && 9 == v)
																		? setTimeout(function () {
											...
											: function (d, e, f, p) {
													...
													var m,
														...
														t = y.ranges;
													p.addNew && !p.extend
														? ((v = g.sel.contains(f)), (m = -1 < v ? t[v] : new oi(f, f)))
														: ((m = g.sel.primary()), (v = g.sel.primIndex));
													'rectangle' == p.unit
														? (p.addNew || (m = new oi(f, f)), (f = Jn(d, e, !0, !0)), (v = -1))
														: ((e = Jo(d, f, p.unit)), (m = p.extend ? Ai(m, e.anchor, e.head, p.extend) : e));
													p.addNew
														? -1 == v
															? ((v = t.length), Ei(g, li(d, t.concat([m]), v), { scroll: !1, origin: '*mouse' }))
															: 1 < t.length && t[v].empty() && 'char' == p.unit && !p.extend
															? (Ei(g, li(d, t.slice(0, v).concat(t.slice(v + 1)), 0), {
																	scroll: !1,
																	origin: '*mouse'
															  }),
															  (y = g.sel))
															: Wi(g, v, m, U)
														: (Ei(g, new ii([m], (v = 0)), U), (y = g.sel));
													var b = f;
													function s(e) {
														if (0 != it(b, e))
															if (((b = e), 'rectangle' == p.unit)) {
																for (
																	var t = [],
																		n = d.options.tabSize,
																		r = P($e(g, f.line).text, f.ch, n),
																		i = P($e(g, e.line).text, e.ch, n),
																		o = Math.min(r, i),
																		l = Math.max(r, i),
																	...
																	o == l
																		...
																		: u.length > c && t.push(new oi(rt(s, c), rt(s, K(u, l, n))));
																}
																t.length || t.push(new oi(f, f)),
																	Ei(g, li(d, y.ranges.slice(0, v).concat(t), v), { origin: '*mouse', scroll: !1 }),
																	d.scrollIntoView(e);
															} else {
																var h,
																	r = m,
	...
	function el(e, t, n, r) {
		...
		for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
			...
			if (a && a.getBoundingClientRect().right >= i)
				return xe(e, n, e, et(e.doc, o), e.display.gutterSpecs[s].className, t), Ne(t);
		}
	}
	function tl(e, t) {
	...
	function nl(e, t) {
		var n, r;
		mn(e.display, t) ||
			((r = t), Le((n = e), 'gutterContextMenu') && el(n, r, 'gutterContextMenu', !1)) ||
			Ce(e, t, 'contextmenu') ||
			x ||
	...
	function ul(e, t) {
		...
		(function (r) {
			var i = r.display;
			ye(i.scroller, 'mousedown', Pr(r, Qo)),
				ye(
					i.scroller,
					'dblclick',
					w && v < 11
			...
			ye(i.scroller, 'touchstart', function (e) {
				...
				ye(i.scroller, 'scroll', function () {
					i.scroller.clientHeight &&
						(Lr(r, i.scroller.scrollTop), Tr(r, i.scroller.scrollLeft, !0), xe(r, 'scroll', r));
				}),
						...
						Ce(r, e) ||
							((n = Jn((t = r), (n = e))) &&
								...
								t.display.dragCursor ||
									((t.display.dragCursor = M('div', null, 'CodeMirror-cursors CodeMirror-dragcursors')),
							...
							void (w && (!t.state.draggingText || +new Date() - fo < 100)
								...
								: Ce(t, n) ||
								  ...
								  n.dataTransfer.setDragImage &&
										!c &&
										(((e = M('img', null, null, 'position: fixed; left: 0; top: 0;')).src =
			...
			ye(e, 'keyup', function (e) {
				...
				ye(e, 'keydown', Pr(r, Xo)),
				ye(e, 'keypress', Pr(r, _o)),
	...
	function hl(e, t, n, r) {
		...
		'prev' == n
			? (u = t > o.first ? P($e(o, t - 1).text, null, l) : 0)
			: 'add' == n
		...
		if ((d < u && (h += X(u - d)), h != c))
			return qi(o, h, rt(t, 0), rt(t, c.length), '+input'), !(s.stateAfter = null);
	...
	function wl(r, i, o, l, s) {
					...
					'codepoint' == l
						? ((t = a.text.charCodeAt(i.ch + (0 < l ? 0 : -1))),
						  isNaN(t)
								...
								: new rt(
										i.line,
										Math.max(0, Math.min(a.text.length, i.ch + o * (55296 <= t && t < 56320 ? 2 : 1))),
										-o
								  ))
						: s
						? Po(r.cm, a, i, o)
		...
		if ('char' == l || 'codepoint' == l) n();
			...
			for (
				var c = null, h = 'group' == l, d = r.cm && r.cm.getHelper(i, 'wordChars'), f = !0;
				!(o < 0) || n(!f);
				f = !1
			) {
	...
	(e.prototype.init = function (e) {
		...
		function n(e) {
			if (a(e) && !Ce(l, e)) {
				if (l.somethingSelected())
					fl({ lineWise: !1, text: l.getSelections() }), 'cut' == e.type && l.replaceSelection('', null, 'cut');
				else {
			...
			if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom)
				...
				if (!o || o.bad || !n || n.bad || 0 != it(at(o, n), r) || 0 != it(st(o, n), i)) {
					...
					if (
						...
						a &&
							(!d && t.state.focused
								? (e.collapse(l.node, l.offset), a.collapsed || (e.removeAllRanges(), e.addRange(a)))
			...
			if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
				...
				this.composing ||
					...
					e &&
						t &&
						Er(r, function () {
							Ei(r.doc, si(e, t), G), (e.bad || t.bad) && (r.curOp.selectionChanged = !0);
						}));
			}
		}),
		(e.prototype.pollContent = function () {
			...
			var o,
				...
				r =
					r == n.view.length - 1
						...
						: ((o = Je(n.view[r + 1].line) - 1), n.view[r + 1].node.previousSibling);
			if (!m) return !1;
			for (
			...
			for (
				...
				++a;
			for (
				var f = Y(l), p = Y(s), g = Math.min(f.length - (1 == l.length ? a : 0), p.length - (1 == s.length ? a : 0));
				u < g && f.charCodeAt(f.length - u - 1) == p.charCodeAt(p.length - u - 1);

			)
				++u;
			if (1 == l.length && 1 == s.length && e == i.line)
				for (; a && a > i.ch && f.charCodeAt(f.length - u - 1) == p.charCodeAt(p.length - u - 1); ) a--, u++;
		...
		(e.prototype.onKeyPress = function (e) {
			0 == e.charCode ||
				...
				(e.preventDefault(),
				this.cm.isReadOnly() ||
					Pr(this.cm, pl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0));
		}),
	...
	(r.prototype.init = function (n) {
		...
		(r.prototype.onContextMenu = function (e) {
			...
			u &&
				!p &&
				(r.options.resetSelectionOnContextMenu && -1 == r.doc.sel.contains(u) && Pr(r, Ei)(r.doc, si(u), G),
				(l = o.style.cssText),
		...
		(Ml.prototype = {
			...
			setOption: function (e, t) {
				var n = this.options,
					r = n[e];
				(n[e] == t && 'mode' != e) ||
					((n[e] = t), Nl.hasOwnProperty(e) && Pr(this, Nl[e])(this, t, r), xe(this, 'optionChange', this, e));
			},
			...
			addOverlay: Ir(function (e, t) {
				...
				!(function (e, t, n) {
					...
					this.state.overlays,
					{ mode: n, modeSpec: e, opaque: t && t.opaque, priority: (t && t.priority) || 0 },
					function (e) {
						return e.priority;
					}
				),
			...
			indentSelection: Ir(function (e) {
				for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
					...
					if (i.empty())
						i.head.line > n &&
							(hl(this, i.head.line, e, !0), (n = i.head.line), r == this.doc.sel.primIndex && wr(this));
					else {
						for (
							var o = i.from(),
								l = i.to(),
			...
			lineAtHeight: function (e, t) {
				return (e = Rn(this, { top: e, left: 0 }, t || 'page').top), et(this.doc, e + this.display.viewOffset);
			},
					...
					e =
						'number' == typeof e
							? ((r = this.doc.first + this.doc.size - 1),
							  e < this.doc.first ? (e = this.doc.first) : r < e && ((e = r), (i = !0)),
							  $e(this.doc, e))
							: e;
				...
				(t.style.position = 'absolute'),
					...
					'over' == r
						...
						: ('above' != r && 'near' != r) ||
						  ...
						  ('above' == r || e.bottom + t.offsetHeight > o) && e.top > t.offsetHeight
					...
					'right' == i
						...
						: ('left' == i ? (u = 0) : 'middle' == i && (u = (s.sizer.clientWidth - t.offsetWidth) / 2),
						  (t.style.left = u + 'px')),
					n &&
						((n = this),
						(t = { left: u, top: a, right: u + t.offsetWidth, bottom: a + t.offsetHeight }),
			...
			moveV: Ir(function (r, i) {
				...
				if (
					(l.extendSelectionsBy(function (e) {
						...
						var n = xl(o, t, r, i);
						return 'page' == i && e == l.sel.primary() && br(o, zn(o, n, 'div').top - t.top), n;
					}, V),
					s.length)
				)
			...
			toggleOverwrite: function (e) {
				(null != e && e == this.state.overwrite) ||
					(((this.state.overwrite = !this.state.overwrite) ? D : L)(this.display.cursorDiv, 'CodeMirror-overwrite'),
	...
	return (
		...
		(ul.fromTextArea = function (t, n) {
			...
			if (
				...
				null == n.autofocus &&
					((e = O()), (n.autofocus = e == t || (null != t.getAttribute('autofocus') && e == document.body))),
